...
namespace RegionMapperGUI {
    public class HeightmapSelection {
        ...
        public Color RowBackColor { get; set; } = Color.FromArgb(40, 40, 40);
        public Color RowSelectionColor { get; set; } = Color.FromArgb(65, 65, 65);

        public Color RowHoverColor { get; set; } = Color.FromArgb(50, 50, 50);
        public Color RowSecondHoverColor { get; set; } = Color.FromArgb(75, 75, 75);
